...
namespace PinionCore.NetSync.Editor.Syncs.Souls.Trackers
{
    ...
    public class TrackerSender: UnityEditor.Editor
    {
        ...
        {
            var root = UnityEditor.AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/PinionCore/NetSync.Tracker/Editor/Resources/Layouts/Syncs/Souls/TrackerSender.uxml");
            if (root == null)
